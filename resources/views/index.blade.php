...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="/">Adam & Dini</a>
    ...
    <section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(images/bg-adam.jpg); background-size:cover; background-position: top center;" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section bg-light" id="greeting-section">
        <div class="container">
            <div class="row justify-content-center pb-5">
                <div class="col-md-12 text-center heading-section ftco-animate">
                    <h2 class="mb-0">Q.S Ar-Rum:21</h2>
                </div>
                <div class="bride-groom ftco-animate">
                <div class="text mt-4 px-4">
                <p class="p-md-3 text-center">
                    <br>
    ...
    <section class="ftco-section " style="background-image: url(images/bg-g.jpg);" id="greeting-section">
        <div class="container">
            <div class="row justify-content-center pb-5">
                <div class="col-md-12 text-center heading-section ftco-animate">
                    <h2 class="mb-3">Wedding Gift</h2>
                </div>
                <div>
                    <p class='text-center'>Bagi keluarga dan sahabat yang ingin mengirimkan hadiah, silakan mengirimkannya melalui tombol berikut:  <br> <br> <button id="myBtn" class='btn btn-dark'><i class="fa fa-gift" aria-hidden="true"></i> Wedding Gift</button></p>
                                   
    
                    <!-- The Modal -->
                    <div id="myModal" class="modal">
                        <div class="modal-content"  style="background-image: url(images/bg-gift1.jpg);">
                            <span class="close">&times;</span>
                            
                                        <p class='text-center'><img width="150" height="100" src="{{ url('images/bca.png')}}" class="attachment-full size-full"  sizes="(max-width: 1600px) 100vw, 1600px"></p>
                                            <h4 class="text-center">No. Rekening : <br> 0551728926 <br> <br>
                                            <button onclick="copyToClipboard('#p1')" class='btn btn-dark' align='center'>Copy</button></h4>
                                        
                                            
                                            <br>  <h3 class="text-center">An. Dini Astuti</h3>  
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="place img" style="background-image: url(images/place-1.jpg);">
                        <div class="text text-center">
                            ...
                            <h3>Akad Nikah</h3>
                            <p><span>Sunday, 12-12-2021</span><br><span>08:00 - 09:00</span></p>
                            <p style="line-height: 1.3">
                                <span class="text-primary">Gedung KODIM 0605/SUBANG</span><br>
                                <small>Jl. Mayjen Sutoyo No.27, Karanganyar, Kec. Subang, Kabupaten Subang, Jawa Barat 41211</small>
                            </p>
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="place img" style="background-image: url(images/place-2.jpg);">
                        <div class="text text-center">
                            ...
                            <h3>The Ceremony</h3>
                            <p><span>Sunday, 12-12-2021</span><br><span>09:00 - 09:45</span></p>
                            <p style="line-height: 1.3">
                                <span class="text-primary">Gedung KODIM 0605/SUBANG</span><br>
                                <small>Jl. Mayjen Sutoyo No.27, Karanganyar, Kec. Subang, Kabupaten Subang, Jawa Barat 41211</small>
                            </p>
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="place img" style="background-image: url(images/place-3.jpg);">
                        <div class="text text-center">
                            ...
                            <h3>The Reception</h3>
                            <p><span>Sunday, 12-12-2021</span><br><span>11:00 - 15:00</span></p>
                            <p style="line-height: 1.3">
                                <span class="text-primary">Gedung KODIM 0605/SUBANG</span><br>
                                <small>Jl. Mayjen Sutoyo No.27, Karanganyar, Kec. Subang, Kabupaten Subang, Jawa Barat 41211</small>
                            </p>
                ...
                <div class="col-md-7">
                    <form action="/rsvp" method="post" class="rsvp-form ftco-animate">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Nama" name="name" maxlength="50" required aria-label="Name">
                        </div>
                        <div class="form-group">
                            <textarea name="message" id="message" cols="30" rows="2" class="form-control" aria-label="Message" placeholder="Berikan Ucapan Dan Doa Restu"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button name='submit' class="btn btn-dark py-3 px-4"> <i class='fa fa-send'></i> Kirimkan Ucapan</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>
                        Copyright &copy; 2021
                        <strong>Adam <i class="icon-heart text-danger" aria-hidden="true"></i> Dini</strong>
                        All rights reserved
                    </p>
                    <small> designed by CV.KLS</small>
                </div>
            </div>
        </div>
    </footer>
